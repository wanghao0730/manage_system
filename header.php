            ...
            <ul>
                ...
                <li>
                    <div id="menu3" class="menuchild" onmouseover="showmenu(3);" onmouseout="hidemenu(3);">
                      ...
                      while($row=@mysqli_detch_assoc($rs)){
                        echo '<a href="product.php?cate_id=1='.$row['id'].'">'.$row['catename'].'</a>';
                      }
                      ?>
                    </div>
                ...
                <li><a href="auout.php?id=4">企业文化</a></li>
...
<div class="notice_bg">
    <div class="notice">
        ...
        while($row=@mysqli_fetch_assoc($rs)){
            ...
            echo '<a target="_blank" href="content.php?id='.$row['id'].'" title="'.$row['title'].'">'.$row['title'].'</a>';
            echo '</li>';
        }
        ?>
        </ul>
